...
public class KafkaConfig {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest"); // Always start from earliest offset
    ...
    public Map<String, Object> producerConfigs() {
        ...
        props.put(ProducerConfig.LINGER_MS_CONFIG, 1); // Adjust for batching if needed
        return props;
    }
