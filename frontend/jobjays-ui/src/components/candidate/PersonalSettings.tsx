...
const PersonalSettings: React.FC = () => {
    ...
    useEffect(() => {
        ...
        fetchPdfFiles();
        //fetchProfileData();
    }, []); // Dependency array: runs when applicantId changes
    //
    ...
    const handleResumeUpload = async (event) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                toast({
                    title: "Error",
                    description: "Upload error!" + errorData.failReason,
                    variant: "default",
                });
            }
        } catch (error) {
    ...
    const handleDeleteResume = async (id) => {
        ...
        try {
            const response = await fetch(`${BASE_URL}/applicants/resume/delete`, {
                method: "POST",
                body: formData
            });
