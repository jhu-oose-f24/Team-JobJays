...
//     };
//
//     // Validation example placeholder
//     const isValidStep = () => {
//         switch (currentStep) {
//             case 1:
//                 return formData.companyInfo !== undefined;
//             case 2:
//                 return formData.foundingInfo !== undefined;
//             case 3:
//                 return formData.contactInfo !== undefined;
//             default:
//                 return true;
//         }
//     };
...
//                     <button className={styles.btn} onClick={nextStep} disabled={!isValidStep()}>
...
//
//     // Ensure the percentage reflects progress through the steps, starting with 0% for step 1
